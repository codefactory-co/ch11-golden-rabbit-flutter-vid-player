...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: video == null ? renderEmpty() : renderVideo(),  // ➋ 동영상이 선택됐을때와 선택 안됐을때 보여줄 위젯
    );
  }
  ...
  Widget renderEmpty() {
    return Container(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,  // 위젯들 가운데 정렬
        children: [
          _Logo(
...
class _Logo extends StatelessWidget { // 앱 제목을 보여줄 위젯
...
class _AppName extends StatelessWidget { // 앱 이름을 보여줄 위젯
